...
locals {
  ...
  image_urls = {
    ...
    opensuse155armo = "${var.use_mirror_images ? "http://${var.mirror}" : "https://download.opensuse.org"}/distribution/leap/15.5/appliances/openSUSE-Leap-15.5-ARM-JeOS-efi.aarch64.qcow2"
